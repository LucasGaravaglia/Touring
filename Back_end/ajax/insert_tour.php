...
$tourist_place_array = (isset($_POST['tourist_place_array']) && !empty($_POST['tourist_place_array'])) ? $_POST['tourist_place_array'] : NULL;
$restaurants_array = (isset($_POST['restaurants_array']) && !empty($_POST['restaurants_array'])) ? $_POST['restaurants_array'] : NULL;

if ($tourist_place_array === null && $user_login_token === NULL)
{
...
else
{
	...
	$tour = new tour("InsertTourRequest", $user_id, NULL, $tourist_place_array, $restaurants_array);
