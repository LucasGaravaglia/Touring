...
class tour
{
	...
	public $tourist_place_array;
	public $restaurants_array;
	public function __construct($action, int $user_id, $tour_request_id, $tourist_place_array, $restaurants_array)
	{
		$this->user_id = $user_id;
		$this->tour_request_id = $tour_request_id;
		$this->tourist_place_array = $tourist_place_array;
	...
	{
		$tour_request_tourist_place_list = serialize($this->tourist_place_array);
		...
		$insert_tour_request = $dbconnection->prepare('INSERT INTO tour_requests (tour_request_user_id, tour_request_tourist_place_list, tour_request_restaurants_list, tour_request_datetime) VALUES (:tour_request_user_id, :tour_request_tourist_place_list, :tour_request_restaurants_list, :tour_request_datetime)');
		$insert_tour_request->bindParam(':tour_request_user_id', $this->user_id, PDO::PARAM_INT);
		$insert_tour_request->bindParam(':tour_request_tourist_place_list', $tour_request_tourist_place_list);
